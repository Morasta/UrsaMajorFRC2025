...
public class DriveRightDiagonalCmd extends Command {
    ...
    public DriveRightDiagonalCmd(DriveTrain driveTrain, double distance) {
    ...
    public void execute() {
        ...
        driveSubsystem.setMotors(0.3, 0, 0, 0.3);
    }
