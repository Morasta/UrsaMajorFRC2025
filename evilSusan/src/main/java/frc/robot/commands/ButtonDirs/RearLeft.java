...
public class RearLeft extends Command {
    ...
    public RearLeft(DriveTrain driveTrain, double distance) {
        this(driveTrain, distance, 1.0);
    }

    public RearLeft(DriveTrain driveTrain, double distance, double speed) {
        printStatus("Created");
    ...
    public void execute() {
        ...
        driveSubsystem.setMotors(0, 1, 0, 0);
    }
