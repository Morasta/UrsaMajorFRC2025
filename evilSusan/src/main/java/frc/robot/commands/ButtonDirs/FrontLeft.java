...
public class FrontLeft extends Command {
    ...
    public FrontLeft(DriveTrain driveTrain, double distance) {
        this(driveTrain, distance, 1.0);
    }

    public FrontLeft(DriveTrain driveTrain, double distance, double speed) {
        printStatus("Created");
    ...
    public void execute() {
        ...
        driveSubsystem.setMotors(1, 0, 0, 0);
    }
